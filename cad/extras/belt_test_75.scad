...
difference()
{
cylinder(h=pulley_t_ht+2,d=pvc_od, $fn=360);
translate([0,0,-1])
cylinder(h=pulley_t_ht+4,d=pvc_od-2.96, $fn=360);
}

teeth = 75;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
motor_shaft = 22;	// NEMA17 motor shaft exact diameter = 5
...
pulley ( "GT2 5mm" , GT2_5mm_pulley_dia , 1.969 , 3.952 ); 
