...
translate([0,0,-3])
cylinder(h=20,d=pvc_od+5, $fn=360);

translate([0,0,-4])
cylinder(h=27,d=pvc_od, $fn=360);

translate([0,15,2])
rotate([90,0,0])
cylinder(h=30,d=5, $fn=360);
}

teeth = 21;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
